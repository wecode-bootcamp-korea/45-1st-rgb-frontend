      ...
      <div className="footerFooter">
        <div className="footerGroup">
          <div className="footerGroup2">
            <div className="footerGroup">
              <div className="footerOverlap" />
              <div className="footerLoginDefault">
                <div className="footerOverlapGroup" />
              </div>
              <div className="footerinnerGroup">
                <p className="footerNotice1">
                  [공지] 5/5, 5/23 '대체 공휴일'휴무 안내 입니다.
                </p>
                <div className="footerNotice2">
                  <p className="footerP">
                    [공지] 개인정보 처리방침 사전 변경 안내(시행일자 : 2023년
                    3월 10일)
                  </p>
                ...
                <div className="footerTermsofusegroup">
                  ...
                  <div className="termsofuseContext">
                    <span className="termsofuseText">
                      ...
                      2118879575 통신판매업신고 2022서울성동01952
                      [사업자정보확인] 전화번호 : 16440560 이메일:
                    </span>
                    <a
                      ...
                      target="_blank"
                    >
                      <span className="termsofuseEmail">
                        customer@29cm.co.kr
                      </span>
                    </a>
                ...
                <div className="customerService">
                  ...
                  <h1 className="customerservicePhone">02-9345-2356</h1>
